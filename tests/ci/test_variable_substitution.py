...
def test_substitute_single_variable(mock_llm):
	...
	modified_history = agent._history_replay.loader._substitute_variables_in_history(
...
def test_substitute_preserves_original_history(mock_llm):
	...
	# Substitute
	agent._history_replay.loader._substitute_variables_in_history(history, {'email': 'new@example.com'})  # type: ignore[arg-type]
...
def test_substitute_empty_variables(mock_llm):
	...
	modified_history = agent._history_replay.loader._substitute_variables_in_history(history, {})  # type: ignore[arg-type]
