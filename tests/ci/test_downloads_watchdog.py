from browser_use.browser.watchdogs.network_downloads import should_auto_download_network_response


def test_downloads_watchdog_skips_generic_text_attachment_without_file_url():
	assert not should_auto_download_network_response(
...
def test_downloads_watchdog_keeps_pdf_network_response():
	assert should_auto_download_network_response(
