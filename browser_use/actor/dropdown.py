"""Low-level native, ARIA, and custom dropdown mechanics."""
...
class DropdownInteractor:
	"""Inspect and select options through CDP without event ownership."""
	...
	async def get_options(self, element_node) -> dict[str, str]:
	...
	async def select_option(self, element_node, text: str) -> dict[str, str]:
