...
from browser_use.agent.message_manager.compaction import MessageCompactor
...
class MessageManager:
	...
	def __init__(
		...
		self.compactor = MessageCompactor(self)
	...
	async def maybe_compact_messages(
		...
		return await self.compactor.maybe_compact_messages(llm, settings, step_info)
